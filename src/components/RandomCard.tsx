...
export default function RandomCard() {
  ...
  return (
    <>
      ...
      >
        <div className="text-[#FCFCF4] pt-20 text-3xl text-center">
        ...
        <button
          ...
          className={`border-2 border-[#372444] bg-[#FCFCF4] mt-20 px-6 py-2 rounded-lg text-xl text-[#372444] hover:opacity-50 ${
